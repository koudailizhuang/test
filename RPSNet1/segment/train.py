...
def parse_opt(known=False):
    ...
    parser.add_argument('--evolve', type=int, default=150, nargs='?', const=300, help='evolve hyperparameters for x generations')
...
def main(opt, callbacks=Callbacks()):
    ...
    # Evolve hyperparameters (optional)
        ...
        for _ in range(opt.evolve):  # generations to evolve
            ...
            NEW_KEYS = ('metrics/precision(B)', 'metrics/recall(B)', 'metrics/mAP_0.5(B)', 'metrics/mAP_0.5:0.95(B)',
            ...
            print_mutation(NEW_KEYS, results, hyp.copy(), save_dir, opt.bucket)
