...
def run(
    ...
    for path, im, im0s, vid_cap, s, img4 in dataset:
        with dt[0]:
            #print(img4.shape)
        ...
        with dt[1]:
            ...
            xx=model(im, augment=augment, visualize=visualize)
            print(xx)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train-seg/exp94/weights/best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=ROOT / 'data/SiCpAl-60', help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default=ROOT / 'data/SiC.yaml', help='(optional) dataset.yaml path')
